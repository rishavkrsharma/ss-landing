    ...
    <header className="fixed inset-x-0 top-0 z-50 transition-all duration-300 bg-transparent backdrop-blur-md shadow-sm">
      ...
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <div className="flex flex-col gap-0 items-center">
              <span className="text-lg font-semibold">SINGH SHARMA</span>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="#"
            className="text-sm/6 font-semibold text-gray-900 rounded-full bg-gray-100 px-4 py-1 hover:bg-gray-200"
          >
